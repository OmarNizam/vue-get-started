          ...
          <div class="card-content">
            <div class="content">
              ...
              <div class="field">
                ...
                <div
                  class="color-line"
                  :style="{ 'background-color': hero.capColor }"
                ></div>
              </div>
              <div class="field">
                <label for="power">
...
export default {
  ...
  data() {
    return {
      hero: {
        id: 20,
        firstName: 'Omar',
        lastName: 'Nizam Aldeen',
        description: 'the cat whispere',
        capColor: '',
        power: '',
        active: true,
      },
  ...
  methods: {
    ...
    saveHero() {
      this.message = JSON.stringify(this.hero, null, '/n');
    },
  },
};
</script>
